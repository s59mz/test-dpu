...
class FM_Radio(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        # Variables
        ##################################################
        self.samp_rate = samp_rate = 8*5*48000
        self.taps = taps = firdes.low_pass(1.0, samp_rate, 150000,50000, firdes.WIN_HAMMING, 6.76)
        self.freq = freq = 98.9

        ##################################################
        # Blocks
        ##################################################
        self._freq_range = Range(88, 108, 0.1, 98.9, 20)
        self._freq_win = RangeWidget(self._freq_range, self.set_freq, 'Freq [MHz]', "counter_slider", float)
        self.top_grid_layout.addWidget(self._freq_win, 0, 0, 1, 4)
        for r in range(0, 1):
        ...
        for c in range(0, 4):
            self.top_grid_layout.setColumnStretch(c, 1)
        self.fir_filter_xxx_0 = filter.fir_filter_ccc(8, taps)
        ...
        self.connect((self.fir_filter_xxx_0, 0), (self.analog_fm_demod_cf_0, 0))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.set_taps(firdes.low_pass(1.0, self.samp_rate, 150000, 50000, firdes.WIN_HAMMING, 6.76))
